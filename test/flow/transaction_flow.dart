...
void main() {
  testWidgets('Should transfer to a contact', (tester) async {
    ...
    final contact = Contact(0, 'vitor', 1245);
    ...
    final contactItem = find.byWidgetPredicate((widget) {
      if (widget is ContactItem) {
        return widget.contact.name == 'vitor' &&
            widget.contact.accountNumber == 1245;
      }
      return false;
    });
    ...
    final contactName = find.text("vitor");
    expect(contactName, findsOneWidget);

    final contactAccountNumber = find.text("1245");
